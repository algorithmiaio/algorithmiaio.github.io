...
The following video walkthrough demonstrates deploying a [scikit-learn model](/model-deployment/scikit) trained in SageMaker.
...
To learn more about model deployment on Algorithmia, see our [Deployment Guides](/model-deployment). Also, see our documentation on [Connecting Your Data](/data) for more information on how to connect your algorithms to your data and model files.
