...
- `API_KEY`: Algorithmia API key that has access to the configured algorithm and which is management capable. More information about Algorithmia API keys can be found [here](https://algorithmiaio.github.io/platform/customizing-api-keys).
